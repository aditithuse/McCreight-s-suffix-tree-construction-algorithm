...
void SuffixTree::longestRepeat()
{
	cout << "\nLength of longest exact matching repeat: " << lowestNode->stringDepth;
	cout << "\nBegin index of exact matching repeat: " << lowestNode->beginLabel - 1;
	cout << "\nEnding index of exact matching repeat: " << lowestNode->endLabel;
}

void SuffixTree::printInfo()
{
	cout << "\nNumber of leaves: " << leafCount;
	cout << "\nNumber of Internal Nodes: " << internalNodeCount;
	cout << "\nTotal Number of nodes: " << leafCount + internalNodeCount;
